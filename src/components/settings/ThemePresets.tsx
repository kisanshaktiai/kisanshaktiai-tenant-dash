...
export const themePresets: ThemePreset[] = [
  ...
  },
  {
    id: 'dark-mode',
    name: 'Dark Elegance',
    description: 'Sophisticated dark theme for modern applications',
  ...
  },
  {
    id: 'earth-tones',
    name: 'Earth Tones',
    description: 'Natural and organic color palette',
  ...
  },
  {
    id: 'spring-blossom',
    name: 'Spring Blossom',
    description: 'Fresh and cheerful theme with pastel colors',
