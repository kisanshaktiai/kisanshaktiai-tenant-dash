...
export const EnhancedFarmerDirectoryOptimized: React.FC<EnhancedFarmerDirectoryProps> = React.memo(({
  onSelectFarmer
}) => {
  ...
  const handleSelectAll = useCallback(() => {
    setSelectedFarmers(prev => 
      prev.length === filteredFarmers.length ? [] : filteredFarmers.map(f => f.id)
    );
  }, [filteredFarmers]);
...
EnhancedFarmerDirectoryOptimized.displayName = 'EnhancedFarmerDirectoryOptimized';
